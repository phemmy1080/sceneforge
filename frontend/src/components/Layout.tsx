  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto p-2 scrollbar-thin">
        ...
        {(!user?.workspace_id || user.workspace_role === 'owner' || !currentStep.startsWith('agency')) && (
          <>
      ...
      {(!user?.workspace_id || user.workspace_role === 'owner' || !currentStep.startsWith('agency')) && activeProject && (
