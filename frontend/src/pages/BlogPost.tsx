...
const ALL_META: PostMeta[] = [
  { slug:'how-to-create-viral-tiktok-videos-with-ai', title:'How to Create Viral TikTok Videos with AI in Under 60 Seconds', description:'Learn how AI video tools help content creators produce scroll-stopping TikToks without a camera, editing skills, or hours of work.', date:'2025-05-01', category:'tutorials', tags:['tiktok','ai video','content creation','viral'], readTime:6 },
  { slug:'best-niches-for-content-creators-2025', title:'The 7 Best Content Niches for Creators in 2025', description:'The most profitable and fastest-growing content niches for TikTok, YouTube Shorts, and Instagram Reels — with specific video ideas for each.', date:'2025-05-05', category:'strategy', tags:['content strategy','niches','youtube shorts','instagram reels'], readTime:8 },
  { slug:'ai-video-tools-comparison-2025', title:'AI Video Creation Tools Compared: Which One is Right for You in 2025?', description:'An honest comparison of the top AI video creation tools in 2025 — features, pricing, and which works best for short-form content creators.', date:'2025-05-08', category:'strategy', tags:['ai tools','comparison','video creation','review'], readTime:7 },
  { slug:'youtube-shorts-algorithm-guide', title:'The YouTube Shorts Algorithm in 2025: What Actually Drives Views', description:'A practical guide to the YouTube Shorts algorithm — what signals matter, what to optimise, and how to get recommended to new viewers.', date:'2025-05-12', category:'strategy', tags:['youtube shorts','algorithm','views','growth'], readTime:7 },
  { slug:'content-creator-monetisation-guide', title:'How Content Creators Monetise in 2025: 7 Revenue Streams That Work', description:'A practical guide to the revenue streams that actually work for content creators — platform income, digital products, affiliate marketing, and more.', date:'2025-05-15', category:'strategy', tags:['monetisation','content creator','income','digital products'], readTime:9 },
]
