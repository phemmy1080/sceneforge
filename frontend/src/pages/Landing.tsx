...
export default function Landing({ onLogin, onSignup }: LandingProps) {
  return (
    <div style={{ minHeight: '100vh', background: '#07070E', color: '#F0F0FF', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1000, margin: '0 auto', padding: '0 clamp(20px, 4vw, 48px)', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)' }}>
            {STATS.map((s, i) => (
              <div key={i} style={{ textAlign: 'center', padding: '28px 16px', borderRight: i < 3 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 30, fontWeight: 800, color: '#A78BFA', letterSpacing: '-1px', marginBottom: 4 }}>{s.value}</div>
            ...
            {STEPS.map((step, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 12, fontWeight: 800, color: '#A78BFA' }}>{step.num}</span>
                </div>
      ...
      <footer aria-label="Site footer" style={{
        ...
        <span aria-label="SceneForge" style={{ fontFamily: "'Syne', sans-serif", fontSize: 15, fontWeight: 800, color: 'rgba(255,255,255,0.80)' }}>
          Scene<span style={{ color: '#A78BFA' }}>Forge</span>
        </span>
