...
const POSTS_META: Omit<Post, 'content'>[] = [
  ...
  },
  {
    ...
    title: 'The 7 Best Content Niches for Creators in 2025',
  ...
  },
  {
    ...
    description: 'An honest comparison of the top AI video creation tools in 2025 — features, pricing, and which works best for short-form content creators.',
    date: '2025-05-08',
    category: 'strategy',
  ...
  },
  {
    ...
    title: 'How Content Creators Monetise in 2025: 7 Revenue Streams That Work',
